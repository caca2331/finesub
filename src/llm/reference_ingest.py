...
from .correction_translation import run_full_correction
from .knowledge.base import DEFAULT_KNOWLEDGE_ROOT
from .knowledge.update import run_knowledge_update
...
def _row_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--gpu-budget-gb", type=int, dest="gpu_budget_gb")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--gpu-budget-gb", type=int, default=8, help="Default GPU budget (GiB).")
...
def main() -> int:
    ...
    results = batch_runner.run_batch(items, status_path=status_path)
