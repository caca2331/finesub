...
状态：**全部完成。** 阶段 A、锚点 `0.5.0pre`、阶段 B（2026-09-03）与阶段 C（2026-09-04：
`v0.5.0` = `4638bb7f`，parent 就是 `0.5.0pre`；GitHub Release 一个 wheel，PyPI `finesub==0.5.0`
可装）。发版前经三轮外部审计，处置记录在 `field-feedback-batch-plan.md` §7 第 7 条与本文 §9。
此后本文只作取舍依据。
